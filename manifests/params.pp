...
class xlrelease::params {
  ...
  $xlr_repository_type          = 'standalone'
  $xlr_datastore_jdbc_driver_url = undef
  $xlr_datastore_url            = undef
  $xlr_datastore_user           = undef
  $xlr_datastore_password       = undef
  $xlr_datastore_databasetype   = undef
